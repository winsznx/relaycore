...
interface Step6NodeData {
    label: string;
    status: 'idle' | 'executing' | 'complete' | 'error';
    output?: Record<string, any>;
}

export const X402Step6Node = memo(({ data }: { data: Step6NodeData }) => {
    ...
    const getStatusIcon = () => {
        switch (data.status) {
            ...
            default: return <Coins className="h-4 w-4 text-emerald-600" />;
        }
    };
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 mb-2">
                {getStatusIcon()}
                <div>
                    <div className="font-semibold text-sm">Step 6: Settle</div>
...
X402Step6Node.displayName = 'X402Step6Node';
