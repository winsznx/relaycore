...
interface Step4NodeData {
    label: string;
    status: 'idle' | 'executing' | 'complete' | 'error';
    output?: Record<string, any>;
}

export const X402Step4Node = memo(({ data }: { data: Step4NodeData }) => {
    ...
    const getStatusIcon = () => {
        switch (data.status) {
            ...
            default: return <Send className="h-4 w-4 text-cyan-600" />;
        }
    };
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 mb-2">
                {getStatusIcon()}
                <div>
                    <div className="font-semibold text-sm">Step 4: Submit</div>
...
X402Step4Node.displayName = 'X402Step4Node';
