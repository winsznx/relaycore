...
interface Step5NodeData {
    label: string;
    status: 'idle' | 'executing' | 'complete' | 'error';
    output?: Record<string, any>;
}

export const X402Step5Node = memo(({ data }: { data: Step5NodeData }) => {
    ...
    const getStatusIcon = () => {
        switch (data.status) {
            ...
            default: return <Shield className="h-4 w-4 text-indigo-600" />;
        }
    };
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 mb-2">
                {getStatusIcon()}
                <div>
                    <div className="font-semibold text-sm">Step 5: Verify</div>
...
X402Step5Node.displayName = 'X402Step5Node';
