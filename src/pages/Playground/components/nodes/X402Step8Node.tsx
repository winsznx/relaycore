...
interface Step8NodeData {
    label: string;
    status: 'idle' | 'executing' | 'complete' | 'error';
    output?: Record<string, any>;
}

export const X402Step8Node = memo(({ data }: { data: Step8NodeData }) => {
    ...
    const getStatusIcon = () => {
        switch (data.status) {
            ...
            default: return <RefreshCw className="h-4 w-4 text-violet-600" />;
        }
    };
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 mb-2">
                {getStatusIcon()}
                <div>
                    <div className="font-semibold text-sm">Step 8: Retry</div>
...
X402Step8Node.displayName = 'X402Step8Node';
